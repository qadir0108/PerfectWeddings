...
namespace PerfectWeddings.Data.EntityManager
{
    ...
    {
        private static PerfectWeddingsContext _dbContext;
        public bool SaveChangesSuccess { get; protected set; }

        public PerfectWeddingsContext CurrentContext
        {
            get
            {
                if (_dbContext == null)
                    _dbContext = new PerfectWeddingsContext();
                return _dbContext;
            }
        }
        ...
        /// </summary>
        public BaseEntityManager(PerfectWeddingsContext dbContext)
        {
            if (dbContext != null)
